...
const (
	// 26 + 26 + 10 + 32 = 94
	// TODO create function that adds const values together to get character set size
...
var (
	...
	ErrExceedsTotalLength = errors.New("number of digits and symbols must be less than total length either increase length or decrease digits and symbols ")
	...
	ErrLettersExceedsAvailable = errors.New("number of letters exceeds available letters and repeats are not allowed either increase length or decrease letters")
	...
	ErrDigitsExceedsAvailable = errors.New("number of digits exceeds available digits and repeats are not allowed either increase length or decrease digits ")
	...
	ErrSymbolsExceedsAvailable = errors.New("number of symbols exceeds available symbols and repeats are not allowed either increase length or decrease symbols")
)
...
// This algorithm favors entropy over speed
...
func TestPasswordEntropy(password string) {
	// TODO intgrate rather than call from main function
	passwordLength := len(password)
	// TODO generate character set size from the const values
	characterSetSize := 94 // Assuming my addition is correct for the character set size
	entropy := math.Log2(math.Pow(float64(characterSetSize), float64(passwordLength)))
	log.Printf("Entropy of password '%s' is %.2f bits\n", password, entropy)
}
